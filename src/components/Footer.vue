            ...
            <v-row>
                <v-col cols="12" sm="4">
                    ...
                    <v-card-text class="grey--text pt-0">
                        Lorem ipsum, dolor sit amet consectetur adipisicing elit. Impedit qui debitis veniam quisquam sunt expedita. <br> 
                        voluptate quae architecto numquam odio sapiente a, recusandae natus distinctio perspiciatis adipisci quibusdam reprehenderit aliquid.                
                    </v-card-text>
