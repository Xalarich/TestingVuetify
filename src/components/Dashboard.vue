<template>
    <v-container fluid>
                ...
                <v-col cols="12" sm="4" class="pl-0">
                    <v-card height="250px" tile flat color="#6857E1">
                        <v-row>
                            ...
                            <v-col cols="12" sm="6">
                                <v-img src="jacket2.png" max-height="250" max-width="420" contain class="mt-n2"></v-img>
                            </v-col>
                        </v-row>
                    </v-card>
                </v-col>
                ...
                <v-col cols="3" class="py-0 pr-0 mt-n3">
                    ...
                    <v-card flat outlined>
                        ...
                        <v-chip-group column multiple active-class="blue white--text" class="ml-2">
                            <v-chip v-for="size in sizes" :key="size" class="size">
                                {{ size }}
                            </v-chip>
                        </v-chip-group>
                    </v-card>
        ...
        <v-card color="#EFF0f2" HEIGHT="250px" tile flat dark class="d-flex align-center justify-center mt-n10" card2>
            <v-row>
                <v-col cols="12" sm="12">
                    <h4 class="text-center black--text mt-14">SUBSCRIBE TO OUR NEWSLETTER</h4>
                </v-col>
                <v-col cols="12" sm="12">
                    <h6 class="text-center grey--text">
                        Lorem ipsum dolor sit amet consectetur adipisicing elit. Impedit suscipit amet praesentium veniam, deleniti sapiente vero ipsa quos qui ab 
                        reprehenderit? Accusantium labore mollitia, dolores perspiciatis amet eveniet dolorum ratione.
                    </h6>
                </v-col>
                <v-col cols="12" sm="12">
